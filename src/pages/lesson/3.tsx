...
import { LESSON3_WORDS } from "@/data/lessons/lesson3";
...
const Lesson3 = () => {
  ...
  const playAudio = () => {
    const currentWord = LESSON3_WORDS[currentWordIndex];
  ...
  const nextWord = () => {
    setCurrentWordIndex((prev) => (prev + 1) % LESSON3_WORDS.length);
  };

  const previousWord = () => {
    setCurrentWordIndex((prev) => 
      (prev - 1 + LESSON3_WORDS.length) % LESSON3_WORDS.length
    );
  };
      ...
      <div className="container mx-auto max-w-4xl">
        ...
        <Card className="mb-8">
          <CardContent className="p-6">
            ...
            <p className="text-gray-600 mb-6">
              Learn essential family-related vocabulary in Mongolian
            </p>
        ...
        <div className="mt-8">
          <p className="text-sm text-gray-500 text-center">
            Progress: {currentWordIndex + 1} / {LESSON3_WORDS.length}
          </p>
        </div>
      </div>
    </div>
